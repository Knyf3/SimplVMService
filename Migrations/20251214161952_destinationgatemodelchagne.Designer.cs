...
namespace SimplVMService.Migrations
{
    ...
    [Migration("20251214161952_destinationgatemodelchagne")]
    partial class destinationgatemodelchagne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimplVMService.Models.GateModel", b =>
                {
                    ...
                    b.Property<Guid?>("DestinationModelDestinationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DestinationModelDestinationId");
            ...
            modelBuilder.Entity("SimplVMService.Models.GateModel", b =>
                {
                    b.HasOne("SimplVMService.Models.DestinationModel", null)
                        .WithMany("Gates")
                        .HasForeignKey("DestinationModelDestinationId");
                });
